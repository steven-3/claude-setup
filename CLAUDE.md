...
- `skills/` — SKILL.md files copied to `~/.claude/skills/` (6 dirs: supermind, supermind-init, supermind-living-docs, anti-rationalization, verification-before-completion, tdd)
