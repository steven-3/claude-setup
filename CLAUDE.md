...
- `skills/` — SKILL.md files copied to `~/.claude/skills/` (7 dirs: supermind, supermind-init, supermind-living-docs, anti-rationalization, verification-before-completion, tdd, systematic-debugging)
